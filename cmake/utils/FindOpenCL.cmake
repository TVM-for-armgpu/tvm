...
macro(find_opencl use_opencl)
  ...
  if(NOT OpenCL_FOUND)
    message(STATUS "Fallback to libopencl")
    add_subdirectory(${PROJECT_SOURCE_DIR}/3rdparty/libopencl-stub)
    set(OpenCL_INCLUDE_DIRS ${PROJECT_SOURCE_DIR}/3rdparty/libopencl-stub/include)
